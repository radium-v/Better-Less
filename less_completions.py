...
class LessCompletions(sublime_plugin.EventListener):
    ...
    def on_query_completions(self, view, prefix, locations):
        ...
        less_selector_scope = "source.less - meta.selector.less"
        ...
        selector_scope = less_selector_scope + ', ' + html_style_attr_selector_scope
        prop_name_scope = "meta.property-name.less"
        prop_value_scope = "meta.property-value.less"
        loc = locations[0]
